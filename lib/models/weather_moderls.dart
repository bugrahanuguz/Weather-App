...
class WeatherModel {
  ...
  WeatherModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['weather'] != null) {
      weather = <WeatherModel2>[];
      json['weather'].forEach((v) {
        weather!.add(new WeatherModel2.fromJson(v));
      });
    }
    base = json['base'];
...
class WeatherModel2 {
  ...
  WeatherModel2({this.id, this.main, this.description, this.icon});

  WeatherModel2.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    main = json['main'];
